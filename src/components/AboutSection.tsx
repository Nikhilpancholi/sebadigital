...
export function AboutSection() {
  const brands = [
    'TDK', 'Panasonic', 'Philips', 'Sony', 'JVC', 'Maxell', 'Memorex',
    'Verbatim', 'Nexis', 'Kingston'
  ];
    ...
    <section className="bg-white py-20">
      <div className="max-w-7xl mx-auto px-6">
        <div className="grid md:grid-cols-2 gap-12 items-center">
          ...
          <div>
            <img
              src="https://images.unsplash.com/photo-1695624825454-7ace45436e27?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxlbGVjdHJvbmljcyUyMHN0b3JlJTIwc2hvcGZyb250JTIwYmx1ZXxlbnwxfHx8fDE3NzA5OTk2MjZ8MA&ixlib=rb-4.1.0&q=80&w=1080"
